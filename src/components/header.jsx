...
export default function Header({ title }) {
    ...
    return (
        <header className="text-center py-3 bg-white grid grid-cols-3">
            ...
            <button onClick={() => subscribeUserToPush()} className="justify-self-end mr-3 text-2xl w-11 h-11 text-gray-400 hover:text-gray-600 col-start-3 row-span-2"><IoIosNotifications className="w-full h-full" /></button>
        </header>
    )
}